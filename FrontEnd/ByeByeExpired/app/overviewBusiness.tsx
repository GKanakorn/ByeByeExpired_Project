            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.storageBox}>
                        <StorageItem title="Fridge" count={17} icon="thermometer-outline" />
                        <StorageItem title="Freezer" count={4} icon="snow-outline" />
                        <StorageItem title="Dry food" count={3} icon="fast-food-outline" />

                        <TouchableOpacity style={styles.addStorage}>
...
const styles = StyleSheet.create({
    ...
    plusMinusContainer: {
        position: "absolute",
        bottom: 110,              // ปรับตามตำแหน่งที่อยากให้ลอยขึ้นมา
        alignSelf: "center",
        flexDirection: "row",     // สำคัญ: ทำให้เรียงแนวนอน
        gap: 40,                  // ระยะห่างระหว่างปุ่ม (React Native ใหม่ๆ ใช้ได้)
    },
